    ...
    return (
        <div className="level-selector-container">
            ...
            <nav>
                ...
                <a href="/level2" className="level-link" onMouseEnter={handleMouseEnter}>2 - Primer Modelo</a>
                <a href="/level3" className="level-link" onMouseEnter={handleMouseEnter}>3 - Naves Espaciales</a>
                <a href="/level3" className="level-link" onMouseEnter={handleMouseEnter}>4 - Walking Simulator</a>
                <a href="/level3" className="level-link" onMouseEnter={handleMouseEnter}>5 - Computer Vision</a>
                <a href="/level3" className="level-link" onMouseEnter={handleMouseEnter}>6 - Identifica Fraudes</a>
